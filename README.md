...
- Consultation des emplois du temps publiés [par les étudiants,si possible par l'enseignant]
...
```bash
git clone https://github.com/BlakvGhost/PIL1_2223_24.git
```
...
Si vous avez des questions ou des doutes, n'hésitez pas à m'ecrire en inbox
...
- [@Groupe24](https://github.com/BlakvGhost/PIL1_2223_24)
